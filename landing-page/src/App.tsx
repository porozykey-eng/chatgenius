      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        ...
        <div className="container max-w-7xl mx-auto flex items-center justify-between px-6">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="/docs/guide/getting-started" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors font-medium flex items-center gap-1">
          ...
          {mobileMenuOpen && (
            ...
            >
              <div className="container max-w-7xl mx-auto px-6 py-4 flex flex-col gap-4">
                ...
                <a href="/docs/guide/getting-started" target="_blank" rel="noopener noreferrer" onClick={() => setMobileMenuOpen(false)} className="text-white/60 hover:text-white transition-colors font-medium py-2 flex items-center gap-2">
                  <BookOpen className="w-4 h-4" />
                  配置指南
                </a>
                <Button 
